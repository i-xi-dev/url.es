...
Example for Skypack
```javascript
import { Uri } from "https://cdn.skypack.dev/@i-xi-dev/url@3.1.9";
```


## Usage

### [`Uri.Absolute`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/url.es/3.1.9/mod.ts/~/Uri.Absolute) class
