...
Example for UNPKG
```javascript
import { Uri } from "https://www.unpkg.com/@i-xi-dev/url@3.1.20/esm/mod.js";
```


## Usage

### [`Uri.Absolute`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/url.es/3.1.20/mod.ts/~/Uri.Absolute) class
